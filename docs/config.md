...
| `detection.ssh`                       | object | SSH detection specification.                                                                                                                                                                                                              |
| `detection.ssh.host`                  | object | SSH host information.                                                                                                                                                                                                                     |
| `detection.ssh.host.address`          | string | SSH host address.                                                                                                                                                                                                                         |
| `detection.ssh.host.port`             | number | (Optional) SSH host port. Default is 22.                                                                                                                                                                                                  |
| `detection.ssh.credential`            | object | SSH credential.                                                                                                                                                                                                                           |
| `detection.ssh.credential.user`       | string | SSH username used for login.                                                                                                                                                                                                              |
| `detection.ssh.credential.password`   | string | SSH password. Not recommended since it's transmitted in plaintext.                                                                                                                                                                        |
| `detection.ssh.credential.privateKey` | string | SSH private key. Recommended over password.                                                                                                                                                                                               |
| `detection.ssh.credential.passphrase` | string | (Optional) Passphrase for private key if it's encrypted.                                                                                                                                                                                  |
| `detection.ssh.command`               | string | (Optional) Command that fetches addresses, by default it's `ip addr show dev <iface> \| grep -oE 'inet ([^/]+)' \| awk '{print $2}'` for IPv4 and `ip -6 addr show dev <iface> \| grep -oE 'inet6 ([^/]+)' \| awk '{print $2}'` for IPv6. |
| `detection.ssh.interface`             | string | Interface that extract addresses from, must not empty when using default command.                                                                                                                                                         |
