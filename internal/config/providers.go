...
type DNSProviderSpec struct {
	...
	Cloudflare *CloudflareSpec `mapstructure:"cloudflare,omitempty"`

	AliCloud *AliCloudSpec `mapstructure:"alicloud,omitempty"`

	DNSPod *DNSPodSpec `mapstructure:"dnspod,omitempty"`

	Huawei *HuaweiCloudSpec `mapstructure:"huawei,omitempty"`

	JD *JDCloudSpec `mapstructure:"jd,omitempty"`

	RFC2136 *RFC2136Spec `mapstructure:"rfc2136,omitempty"`
}
...
type CloudflareSpec struct {
	...
	APIToken *string `mapstructure:"apiToken,omitempty"`

	// GlobalAPIKey is the global API key with full permission to access Cloudflare API
	GlobalAPIKey *string `mapstructure:"globalApiKey,omitempty"`
...
type DNSPodSpec struct {
	...
	LineID *string `mapstructure:"lineId,omitempty"`
}
...
type JDCloudSpec struct {
	...
	ViewID *int `mapstructure:"viewId,omitempty"`
}
...
type RFC2136Spec struct {
	...
	UseTCP *bool `mapstructure:"useTcp,omitempty"`

	TSIG *TSIGSpec `mapstructure:"tsig,omitempty"`

	GSSTSIG *GSSTSIGSpec `mapstructure:"gssTsig,omitempty"`
}
